...
(function () {
  ...
  /* Stay with me — the Lent path. Six weeks, forty rooms, counted from
     Ash Wednesday. Week one is Seven Days in unbleached clothes. Titles
     stay under nine characters so seven fit across a phone. */
  const LENT_REST = [
    pick('Fast', 'Matthew 6:16', 'Moreover when ye fast, be not, as the hypocrites, of a sad countenance: for they disfigure their faces, that they may appear unto men to fast. Verily I say unto you, They have their reward.', 'He does not forbid the fast. He forbids the performance. Hunger can be quiet.'),
    pick('Bread', 'John 6:35', 'I am the bread of life: he that cometh to me shall never hunger; and he that believeth on me shall never thirst.', 'Hunger is honest. He does not scold it. He names himself as enough.'),
    pick('Thirst', 'John 7:37', 'If any man thirst, let him come unto me, and drink.', 'No credential is asked for. Thirst is the ticket.'),
    pick('Ask', 'Matthew 7:7', 'Ask, and it shall be given you; seek, and ye shall find; knock, and it shall be opened unto you:', 'Three verbs and a door. He does not describe the room behind it. He tells you to knock.'),
    pick('First', 'Matthew 6:33', 'But seek ye first the kingdom of God, and his righteousness; and all these things shall be added unto you.', 'The list does not shrink. The order changes. One thing goes first.'),
    pick('Birds', 'Luke 12:7', 'But even the very hairs of your head are all numbered. Fear not therefore: ye are of more value than many sparrows.', 'Counted is the opposite of forgotten. Fear has less room when you are known.'),
    pick('Flock', 'Luke 12:32', 'Fear not, little flock; for it is your Father\'s good pleasure to give you the kingdom.', 'Little is not an insult. It is the size he chooses to give to.'),
    pick('Lost', 'Luke 15:4–5', 'What man of you, having an hundred sheep, if he lose one of them, doth not leave the ninety and nine in the wilderness, and go after that which is lost, until he find it? And when he hath found it, he layeth it on his shoulders, rejoicing.', 'You are not an acceptable loss. He goes after the one, and he is glad when he finds you.'),
    pick('Learn', 'Matthew 9:13', 'But go ye and learn what that meaneth, I will have mercy, and not sacrifice: for I am not come to call the righteous, but sinners to repentance.', 'He says who he came for. If you are not qualified, you are on the list.'),
    pick('Mourn', 'Matthew 5:4', 'Blessed are they that mourn: for they shall be comforted.', 'He does not hurry grief. He blesses it and promises company.'),
    pick('Meek', 'Matthew 5:5', 'Blessed are the meek: for they shall inherit the earth.', 'The earth is not seized. It is received. Gentleness is not a vacancy.'),
    pick('Poor', 'Matthew 5:3', 'Blessed are the poor in spirit: for theirs is the kingdom of heaven.', 'Empty hands are not a failure. They are how the kingdom is held.'),
    pick('Judge', 'Matthew 7:1', 'Judge not, that ye be not judged.', 'One sentence. The ledger you keep on others is the one that will be opened on you.'),
    pick('Give', 'Matthew 5:42', 'Give to him that asketh thee, and from him that would borrow of thee turn not thou away.', 'Lent is not only going without. It is not turning away.'),
    pick('Watch', 'Matthew 25:13', 'Watch therefore, for ye know neither the day nor the hour wherein the Son of man cometh.', 'Attention you keep, not a countdown you control.'),
    pick('Still', 'Mark 4:39', 'Peace, be still.', 'Three words to a storm. He does not explain the weather. He speaks to it.'),
    pick('Heart', 'John 14:1', 'Let not your heart be troubled: ye believe in God, believe also in me.', 'He speaks to a room about to break. Belief here is company, not a quiz.'),
    pick('Fear', 'Matthew 10:28', 'And fear not them which kill the body, but are not able to kill the soul: but rather fear him which is able to destroy both soul and body in hell.', 'He names the smaller fear so the larger one can be honest.'),
    pick('Cheer', 'John 16:33', 'These things I have spoken unto you, that in me ye might have peace. In the world ye shall have tribulation: but be of good cheer; I have overcome the world.', 'He tells the truth about the world first. Cheer is not denial.'),
    pick('Hour', 'Matthew 24:42', 'Watch therefore: for ye know not what hour your Lord doth come.', 'The hour is not yours to schedule. Staying awake is.'),
    pick('Friend', 'John 15:13', 'Greater love hath no man than this, that a man lay down his life for his friends.', 'The measure of love is not a feeling. It is a life set down.'),
    pick('Stay', 'Matthew 26:38', 'My soul is exceeding sorrowful, even unto death: tarry ye here, and watch with me.', 'He asks for company, not a solution. Staying is the work.'),
    pick('Cup', 'Luke 22:42', 'Father, if thou be willing, remove this cup from me: nevertheless not my will, but thine, be done.', 'He does not pretend the cup is sweet. Honesty and obedience can sit in one sentence.'),
    pick('Cross', 'Luke 9:23', 'If any man will come after me, let him deny himself, and take up his cross daily, and follow me.', 'Daily. Not once, in a story. The weight is today\'s, and he is already ahead.'),
    pick('Life', 'John 11:25–26', 'I am the resurrection, and the life: he that believeth in me, though he were dead, yet shall he live: And whosoever liveth and believeth in me shall never die.', 'He does not offer a theory of death. He offers himself in the middle of it.'),
    pick('Shepherd', 'John 10:11', 'I am the good shepherd: the good shepherd giveth his life for the sheep.', 'Care that costs nothing is a hireling. He stays when it is expensive.'),
    pick('Sent', 'John 20:21', 'Peace be unto you: as my Father hath sent me, even so send I you.', 'Peace first. Then a sending. You do not go unaccompanied.'),
    pick('Wheat', 'John 12:24', 'Verily, verily, I say unto you, Except a corn of wheat fall into the ground and die, it abideth alone: but if it die, it bringeth forth much fruit.', 'What looks like an ending is how fruit begins. He says this on the way to his own.'),
    pick('Them', 'Luke 23:34', 'Father, forgive them; for they know not what they do.', 'From the cross, a sentence for the people still holding the hammer.'),
    pick('Today', 'Luke 23:43', 'Verily I say unto thee, To day shalt thou be with me in paradise.', 'A dying thief is given today, not a waitlist. Mercy does not arrive late.'),
    pick('Near', 'John 14:18', 'I will not leave you comfortless: I will come to you.', 'The last rooms are a promise, not a wrap-up. He comes to you.')
  ];

  const LENT_LAST = [
    pick('Here', 'John 12:46', 'I am come a light into the world, that whosoever believeth on me should not abide in darkness.', 'Not a theory of light. Arrival. The paper is quieter because he is here.'),
    pick('Done', 'John 19:30', 'It is finished:', 'Three words. The work is his. You do not have to complete what he already has.')
  ];

  window.RLA_LENT = {
    id: 'lent',
    name: 'Stay with me',
    weeks: ['Ashes', 'Hunger', 'Mercy', 'Watch', 'Cup', 'Near'],
    days: weekOne().concat(LENT_REST, LENT_LAST).map(function (d, i) {
      d.week = Math.floor(i / 7);
      return d;
    })
  };
  ...
  window.RLA_pathList = function (kind) {
    ...
    if (kind === 'lent' && window.RLA_LENT) return window.RLA_LENT.days;
