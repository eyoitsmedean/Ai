...
class RedWordsWidget : AppWidgetProvider() {
    ...
    companion object {
        ...
        /**
         * Locked seven from `assets/moments/catalog.json`. Used before first
         * open. Regenerated by `node scripts/export-widget-seed.js`.
         */
        // BEGIN_SEED
        ...
        fun slotFor(context: Context, nowMs: Long): WordSlot {
            val stored = rotation(context)
            val slots = if (stored.isEmpty()) bundled else stored
            if (slots.isEmpty()) {
