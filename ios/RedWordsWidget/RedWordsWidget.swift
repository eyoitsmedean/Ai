...
enum WordStore {
  ...
  /// Locked seven from `assets/moments/catalog.json`. Used before first open
  /// and whenever the App Group is empty. Regenerated by
  /// `node scripts/export-widget-seed.js`.
  // BEGIN_SEED
  static let bundled: [WordSlot] = [
    WordSlot(
      word: "But even the very hairs of your head are all numbered. Fear not therefore: ye are of more value than many sparrows.",
      citation: "Luke 12:7"
    ),
    WordSlot(
      word: "Take my yoke upon you, and learn of me; for I am meek and lowly in heart: and ye shall find rest unto your souls.",
      citation: "Matthew 11:29"
    ),
    WordSlot(
      word: "These things I have spoken unto you, that in me ye might have peace. In the world ye shall have tribulation: but be of good cheer; I have overcome the world.",
      citation: "John 16:33"
    ),
    WordSlot(
      word: "Let your light so shine before men, that they may see your good works, and glorify your Father which is in heaven.",
      citation: "Matthew 5:16"
    ),
    WordSlot(
      word: "These things have I spoken unto you, that my joy might remain in you, and that your joy might be full.",
      citation: "John 15:11"
    ),
    WordSlot(
      word: "But seek ye first the kingdom of God, and his righteousness; and all these things shall be added unto you.",
      citation: "Matthew 6:33"
    ),
    WordSlot(
      word: "Let not your heart be troubled: ye believe in God, believe also in me.",
      citation: "John 14:1"
    ),
  ]
  // END_SEED
  ...
  static func slot(for date: Date) -> WordSlot {
    let stored = rotation()
    let slots = stored.isEmpty ? bundled : stored
