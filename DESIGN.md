...
**The words of Jesus are the interface. Everything else is furniture.**

If you removed the navigation, the first screen would still say *red letter* — not because the chrome is crimson, but because a sentence is set in red, on paper, as if a printer had dipped the type.
...
## What “done” looks like for a human who notices

- They open it and exhale.
- They can find the day’s words in one glance.
- They never wonder what is tappable.
- They share a card that looks designed, not generated.
- They do not feel managed, scored, or sold.
- They would show the Today screen to a friend and say: *this is what I mean by taste.*
