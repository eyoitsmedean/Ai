...
| Ordinary words route by one `guessThemes` on both composers: 'hit me up' is money not a wound; 'I hit my head' is not Shame; IVF / a baby shower is Grief; talking to the ceiling is Faith | unverified — running | eval identity on `life-08`, `life-10`, `life-31`, `edge-08`, `edge-15`, `forgery-05`; `public/data/rooms.js` |
