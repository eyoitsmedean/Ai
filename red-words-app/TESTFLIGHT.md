...
The exact click path is [`MAC-TESTFLIGHT.md`](MAC-TESTFLIGHT.md). This file stays as a short founder checklist.

1. Open `red-words-app/ios/Runner.xcworkspace` in Xcode on macOS (not the `.xcodeproj` alone).
