...
abstract final class Brand {
  ...
  /// In-app splash hold. Combined with native launch, this stays under 1.5s
  /// once the bundled pack is in memory. Saying cannot appear before the pack.
  static const splashHold = Duration(milliseconds: 900);
  static const splashMax = Duration(milliseconds: 1500);
