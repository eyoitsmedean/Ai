...
void main() {
  ...
  test('splash hold stays under 1.5s', () {
    expect(Brand.splashHold, lessThanOrEqualTo(Brand.splashMax));
    expect(Brand.splashMax, const Duration(milliseconds: 1500));
    final main = File('lib/main.dart').readAsStringSync();
    expect(main, contains('Brand.splashHold'));
    expect(main, isNot(contains('Duration(seconds:')));
  });
