...
flutter test             +88: All tests passed!
flutter build appbundle --release
Running Gradle task 'bundleRelease'...   164.1s
✓ Built build/app/outputs/bundle/release/app-release.aab (49.5MB)
```

Read back from the AAB: 100 WEB sayings; first `anxiety-mt-6-34` / Matthew 6:34; books John/Luke/Mark/Matthew. Merged release manifest: `package=com.redwords.redwords`, label `Red Words`, `minSdkVersion=24`, `targetSdkVersion=36`, no `INTERNET`. Widget + launcher icons present. Placeholder signer (`CN=Red Words Placeholder`) — not Play.

```
4064f81bce2c082ba3662be4746e4e449e2ae67204620e8aea2eecf91506c039  app-release.aab
```

---

Three earlier runs on Linux agents (prior `red_words/` path). All green.
