...
(function () {
  const PACKS = [
    ...
    { theme: 'Integrity', hear: 'The next word wants to be smoother than the truth — a richer story, a safer oath, a second master.', close: 'Let the next word be a true yes or a true no. You do not have to finish the cost tonight.', keys: ['lie to', 'lying to', 'asked me to lie', 'wants me to lie', 'told me to lie', 'cover it up', 'cover this up', 'cook the books', 'falsify', 'dishonest', 'integrity', 'swear that', 'swear this', 'swear not', 'false report', 'make up a story', 'boss wants me to lie', 'two masters', 'mammon', 'make me rich', 'sow a seed', 'all oaths', 'affidavit'] }
  ];
