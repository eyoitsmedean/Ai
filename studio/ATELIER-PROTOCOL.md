...
*Dean's text, recorded verbatim on 6 September 2026. This is the governing protocol for every agent in this repository. It supersedes `DEANS-MASTERPIECE-PROTOCOL.md` (v2, 4 September 2026), which is kept for history. The per-project brief template lives in `briefs/TEMPLATE.md`; filled briefs in `briefs/`.*
