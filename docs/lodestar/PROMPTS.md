...
|---|---|---|---|
| 1 | Product brief | “Review my projects and everything you can find about me and build me 5 business plans to make money myself in 90 days. Work hard on this and create something beautiful to use and easy to execute” | The only original commission. Five plans. Personal cash. Beautiful. Easy. |
| 2 | Process · FORGE | Take ownership of the established project. The intended user can use the result. Report what actually ran. | Finish; inspectable claims. |
| 3 | Process · ATELIER | Principal-level practitioner. Understand the commission. Anything that requires him to finish or assemble your work is a defect. | No leftover assembly. |
| 4 | Process · Rebuild | Learn what is known, research, rebuild in the native artifact, QA twice. | Playbook, not a new product. |
| 5 | Follow-up | “Massive sprint time get to it pick 5 priorities and push for 45 minutes to an hour” | Speed on the same project. |
