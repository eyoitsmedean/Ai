...
| Minor | Atlas verses hand-copied | Changing `lib/curated.js` first verse would not update the page | `npm run curated` writes `atlas.html` from `lib/curated.js` | ATELIER |
