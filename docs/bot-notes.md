...
Recorded in `RELEASE.md` of the commit that follows the test run.

## Left for Dean

- `docs/SHIP.md` actions 1–3 (deploy, live eval, device steps 5/6/8).
- Re-open rainn.org before flip.
