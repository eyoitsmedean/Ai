...
See `CLAUDE.md` D1–D13. In one line: advisor-first, red-letter only, model never types a verse, PWA, fixed letters for crisis/danger/assault, cache version bump is atomic (`?v=21` + `rla-v22-chapel`).
