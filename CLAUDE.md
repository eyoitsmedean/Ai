...
| --- | --- | --- |
| Node suite (78 tests: corpus verse counts, seal, Forty order, Advisor classification and letters, crisis-regex parity, on-device composer parity, `/ask` stop + routes + `/gate` `/letter`) | verified 2026-09-14 | `npm test` |
