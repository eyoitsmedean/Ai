...
| D11 | Cache versioning: bump `?v=N` in `public/index.html`, the matching entries in `public/sw.js`, and the cache name `rla-vN-chapel` together. Currently **v21**. | DEPLOY.md |
...
| World English Bible text | Public domain worldwide; "World English Bible" is a trademark of eBible.org (do not rename altered text). | [ebible.org/engwebp/copyright.htm](https://ebible.org/engwebp/copyright.htm) (the older `/web/copyright.htm` path 404’d on 2026-09-14) | Copy, sell, distribute freely. |
