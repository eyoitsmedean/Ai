...
| Evaluation: `npm run eval` and `npm run eval -- --client` must pass (75 questions, five gates, both composers) before any release; results are committed in `eval/` | settled 2026-09-06 | scripts/eval.js, eval/ |
