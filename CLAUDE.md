...
| `/ask` crisis and abuse paths **stop** — name a human hotline, no Gospel counsel after 988. Folio Advisor letters still add verses (known drift; eval encodes them) | locked 2026-09-11 on `/ask` | `lib/ask.js`; folio: `lib/advise.js` |
