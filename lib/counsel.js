...
const EXTRA_CUES = [
  ...
  [/\b(lie to|lying to|asked me to lie|wants me to lie|told me to lie|cover (?:it|this) up|cook the books|falsify|dishonest|integrity|swear (?:that|this|the)|false (?:report|number|claim)|make up a (?:story|number)|not tell (?:the|them|him|her) the truth|boss wants me to lie|two masters|mammon|make me rich|sow a seed)\b/i, 'Integrity', 3],
