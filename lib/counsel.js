...
const VOICE = {
  ...
  Integrity: {
    hear: 'The next word wants to be smoother than the truth — a richer story, a safer oath, a second master.',
    close: 'Let the next word be a true yes or a true no. You do not have to finish the cost tonight.',
  },
};
...
/* Wrong first word for present danger: enemy-love, cheek-turn, and "forgive so you may be forgiven"
   used as a return-to-the-abuser rule (USCCB, When I Call for Help, opened 2026-09-11 / 2026-09-14). */
const ENEMY_LOVE = /\b(Matthew 5:39|Matthew 5:44|Luke 6:27|Luke 6:28|Matthew 5:38|Matthew 6:14|Matthew 6:15)\b/;
...
const EXTRA_CUES = [
  ...
  [/\b(lie to|lying to|asked me to lie|wants me to lie|told me to lie|cover (?:it|this) up|cook the books|falsify|dishonest|integrity|swear (?:that|this|the|not)|false (?:report|number|claim)|make up a (?:story|number)|not tell (?:the|them|him|her) the truth|boss wants me to lie|two masters|mammon|make me rich|sow a seed|all oaths|refuse (?:all )?oaths|affidavit|swear not at all)\b/i, 'Integrity', 3],
...
const ROOM_PRIORITY = [
  'Grief & Loss', 'Suffering & Pain', 'Shame & Guilt', 'Integrity', 'Fear', 'Loneliness', 'Forgiveness',
