...
const THEMES = {
  ...
  Integrity: {
    ...
    opening: 'Someone asked you to make the story smoother than the truth. Jesus does not write a workplace code. He names split speech — a sacred oath covering an ordinary lie — and a second master that wants your mouth.',
    passages: [
      passage('Matthew 5:37', 'The surplus speech is the problem. A true yes or a true no is enough; the extra is how the story gets bent.'),
      passage('Matthew 6:24', 'When the pressure is a quota or a paycheck, he names two masters. Mammon is trust, not the fact of a wage.'),
      passage('Luke 16:10', 'Faithfulness starts in the small report, not in the heroic refusal you have not been asked for yet.'),
    ],
    practice: 'Say the next sentence you will actually stand behind. If you cannot say it, do not dress it. One honest no is enough for this hour.',
