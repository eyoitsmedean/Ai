...
const THEMES = {
  ...
  'Conflict & Relationships': {
    ...
    more: [
      ...
      passage('Matthew 5:23-24', 'Reconciliation outranks the offering. Go first.'),
    ],
  ...
  'Faith & Doubt': {
    ...
    more: [
      ...
      passage('Matthew 17:20', 'A grain is enough. He measures faith by its object, not its size.'),
    ],
  ...
  'Suffering & Pain': {
    ...
    more: [
      ...
      passage('Matthew 9:22', 'Comfort spoken to a body. He does not separate the two.'),
    ],
