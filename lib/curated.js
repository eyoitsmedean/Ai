...
const THEMES = {
  ...
  Forgiveness: {
    ...
    passages: [
      ...
      passage('Matthew 18:21-22', 'Seventy times seven is not arithmetic. It is a way of life that stops counting.'),
  ...
  'Conflict & Relationships': {
    ...
    passages: [
      passage('Matthew 5:23-24', 'He interrupts worship itself for this. The person you are at odds with comes before the gift.'),
      passage('Matthew 7:12', 'Not a rule for winning. A rule for how to treat someone while you are still angry.'),
  ...
  Fear: {
    ...
    passages: [
      ...
      passage('Matthew 14:27', 'Spoken across the water to men who thought they were seeing a ghost. The first word against fear is that He is here.'),
    ],
