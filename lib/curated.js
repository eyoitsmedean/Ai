...
const SEVEN = [
  ...
  day('Go', 'Presence', 'Matthew 28:20', 'The last word of the seven is not goodbye. It is presence that does not expire. Go — He goes too.'),
];
...
const FORTY = [
  ...
  day('Anointed', 'Purpose', 'Luke 4:18', 'His purpose statement is toward the poor, the broken, the locked. That is the work.'),
