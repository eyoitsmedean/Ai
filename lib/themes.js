...
const KEYWORDS = {
  ...
  'Forgiveness': ['forgive, and ye shall be forgiven', 'love your enemies', 'be ye therefore merciful', 'father, forgive them', 'until seventy times seven', 'sins be forgiven thee', 'sins, which are many, are forgiven'],
  Loneliness: ['leave you comfortless', 'i am with you alway', 'continue ye in my love'],
  'Conflict & Relationships': ['pray for them which despitefully', 'lay down his life for his friends', 'first be reconciled', 'whatsoever ye would that men should do to you'],
  Fear: ['fear not, little flock', 'be not afraid, only believe', 'hairs of your head', 'it is i; be not afraid', 'be not afraid'],
  ...
  'Shame & Guilt': ['go after that which is lost', 'joy shall be in heaven', 'i am the bread of life', 'neither do i condemn thee', 'sins be forgiven thee', 'sins, which are many, are forgiven'],
  Peace: ['peace i leave with you', 'peace, be still', 'not as the world giveth', 'labour and are heavy laden'],
