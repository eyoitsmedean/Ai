...
const LEXICON = [
  ...
  // Bare "making money" is usually an accusation, not a money worry.
  { cue: /\b((?<!making )money|rent|bills?|debt|afford|broke|poor|paycheck|income|feed my|no money|out of money)/, terms: ['treasure', 'mammon', 'raiment', 'fowls', 'barns', 'feedeth', 'eat', 'drink', 'kingdom', 'first', 'sufficient'], themes: ['Anxiety & Worry'] },
  ...
  { cue: /\b(estrange|won'?t speak|not speaking|stopped speaking|cut me off|no contact|won'?t talk|won'?t answer|walked out on)/, terms: ['father', 'son', 'compassion', 'lost', 'found', 'alive again', 'kissed', 'ran', 'sheep', 'rejoice'], themes: ['Shame & Guilt'] },
  ...
  { cue: /\b(addict|drinking|drunk|alcohol|drugs|gambling|porn|craving|sober|clean for|(?:can'?t|cannot) stop (?:drinking|using|gambling|watching))/, terms: ['sin', 'servant', 'free', 'flesh', 'weak', 'spirit', 'watch', 'drunkenness', 'surfeiting', 'rest'], themes: ['Shame & Guilt'] },
  ...
  { cue: /\b(scam|prove (?:jesus|he|god) (?:even )?exist|didn'?t exist|never existed|jesus is (?:a )?myth|fake gospel|made (?:this|him|it) up)/, terms: ['authority', 'sign', 'tempt', 'generation', 'believe'], themes: [] },
