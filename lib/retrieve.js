...
const NEED_CUES = [
  ...
  [/\b(forgiv|resent|bitter|hate (?:them|him|her|my)|trespass|apolog|betray|cheated on|lied to me)/i, 'Forgiveness'],
  ...
  [/\b(purpose|direction|calling|what should i do|wasted my life|no purpose|lost my job|got fired|laid off|next step)/i, 'Purpose & Direction'],
  [/\b(doubt|unbelief|have not seen|faith|believe anymore|hear nothing|pray|hears? me|listening to me)/i, 'Faith & Doubt'],
  [/\b(pain|suffer|sick|illness|tribulation|cancer|leukemia|diagnos|exhaust|burn(?:ed|t) out|weary|worn out|killing me|hours a week|hour weeks|abus|assault|raped|molest|hurt me)/i, 'Suffering & Pain'],
  [/\b(shame|guilt|ashamed|unworthy|relapse|disgust)/i, 'Shame & Guilt'],
  [/\b(peace|calm|still|quiet my)/i, 'Peace'],
  [/\b(hope|joy|cheer|future|numb|feel nothing|empty inside)/i, 'Hope'],
