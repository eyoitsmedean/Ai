...
/* Stems match at a word start with no closing boundary, so "worried", "lonely", "forgiving" all land. */
const NEED_CUES = [
  [/\b(anxi|worr|overwhelm|stress|tomorrow|panic)/i, 'Anxiety & Worry'],
  [/\b(grie[fv]|mourn|died|death|funeral|widow)/i, 'Grief & Loss'],
  [/\b(forgiv|resent|bitter|hate them|trespass)/i, 'Forgiveness'],
  [/\b(lonel|alone|abandon|orphan|left me)/i, 'Loneliness'],
  [/\b(fight|conflict|marriage|divorce|enem|argu)/i, 'Conflict & Relationships'],
  [/\b(afraid|fear|scared|terr(?:or|ified|ifying)|frighten)/i, 'Fear'],
  [/\b(purpose|direction|calling|what should i do)/i, 'Purpose & Direction'],
  [/\b(doubt|unbelie|have not seen|faith)/i, 'Faith & Doubt'],
  [/\b(pain|suffer|sick|illness|tribulation)/i, 'Suffering & Pain'],
  [/\b(shame|guilt|ashamed|unworthy)/i, 'Shame & Guilt'],
  [/\b(peace|calm|be still)\b/i, 'Peace'],
