...
npm test               # 123 tests: routes, verification, streaming, safety pack, wipe contracts, cite labels
```
...
npm run qa-fresh   # Chrome: /?fresh=1 wipe, welcome fonts, Today · KJV, Leave quickly
```
