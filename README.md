...
**Watch — not a launch.** Start at `http://localhost:3000/desk` (Hear → Record → Ask). `/ask` is the one-screen advisor. Crisis names 988 and stops. The folio at `/` stays paper. Dean records WEB or KJV (US) before any public URL. Do not store-submit. See `docs/CANONICAL-BRIEF.md`.
